...
) : IOrderService
    {
        ...
        public async Task<OrderResultDto> CreateOrderAsync(OrderRequestDto orderRequest, string userEmail)
        {
            ...
            foreach (var item in basket.Items)
            {
                ...
                var orderItem = new OrderItem(product: new ProductInOrderItem(product.Id, product.Name, product.PictureUrl), item.Quantity, item.Price);
            ...
            // 4. TODO: Create Payment Intent Id ---

            // Create Order
            var order = new Order(userEmail, address, orderItems, deliveryMethod, subTotal, paymentIntentId: "");
